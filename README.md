...
因为没有导师反馈，整个实验全靠自己试错和修正。实验经历了n个阶段，第一阶段是自己无用的修改和阅读clip源码，第二阶段的关键改进正来自于对第一阶段失败的诊断。
...
数据：在 Kaggle 上添加 [SeaShips(7000)](https://www.kaggle.com/datasets/dongly/shipdataset)。
